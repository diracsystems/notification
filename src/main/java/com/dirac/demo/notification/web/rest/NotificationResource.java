...
import com.dirac.demo.notification.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.dirac.demo.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
